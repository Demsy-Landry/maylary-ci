...
window.REFERENCE = (function () {
  ...
  var MONNAIES = [
    /* --- parités fixes, ancrages légaux : elles ne bougent pas -------- */
    ...
    /* Le franc comorien et le franc Pacifique sont arrimés à l'euro, mais
     * leur parité avec le franc CFA est une valeur dérivée, pas un ancrage
     * publié. Plutôt que d'en livrer une arrondie, on les traite comme les
     * autres : le taux se saisit. */
    { code: 'KMF', nom: 'Franc comorien',               parite: null, courant: false },
    { code: 'XPF', nom: 'Franc Pacifique',              parite: null, courant: false },

    /* --- monnaies courantes des fournisseurs et des acheteurs --------- */
    { code: 'USD', nom: 'Dollar des États-Unis',        parite: null, courant: true },
    { code: 'CNY', nom: 'Yuan renminbi chinois',        parite: null, courant: true },
    { code: 'AED', nom: 'Dirham des Émirats arabes unis', parite: null, courant: true },
    { code: 'GBP', nom: 'Livre sterling',               parite: null, courant: true },
    { code: 'INR', nom: 'Roupie indienne',              parite: null, courant: true },
    { code: 'TRY', nom: 'Livre turque',                 parite: null, courant: true },
    { code: 'MAD', nom: 'Dirham marocain',              parite: null, courant: true },
    { code: 'GHS', nom: 'Cedi ghanéen',                 parite: null, courant: true },
    { code: 'NGN', nom: 'Naira nigérian',               parite: null, courant: true },

    /* --- Afrique ------------------------------------------------------ */
    { code: 'DZD', nom: 'Dinar algérien',               parite: null, courant: false },
    { code: 'AOA', nom: 'Kwanza angolais',              parite: null, courant: false },
    { code: 'BIF', nom: 'Franc burundais',              parite: null, courant: false },
    { code: 'BWP', nom: 'Pula botswanais',              parite: null, courant: false },
    { code: 'CDF', nom: 'Franc congolais',              parite: null, courant: false },
    { code: 'CVE', nom: 'Escudo cap-verdien',           parite: null, courant: false },
    { code: 'DJF', nom: 'Franc de Djibouti',            parite: null, courant: false },
    { code: 'EGP', nom: 'Livre égyptienne',             parite: null, courant: false },
    { code: 'ERN', nom: 'Nakfa érythréen',              parite: null, courant: false },
    { code: 'ETB', nom: 'Birr éthiopien',               parite: null, courant: false },
    { code: 'GMD', nom: 'Dalasi gambien',               parite: null, courant: false },
    { code: 'GNF', nom: 'Franc guinéen',                parite: null, courant: false },
    { code: 'KES', nom: 'Shilling kényan',              parite: null, courant: false },
    { code: 'LRD', nom: 'Dollar libérien',              parite: null, courant: false },
    { code: 'LSL', nom: 'Loti lesothan',                parite: null, courant: false },
    { code: 'LYD', nom: 'Dinar libyen',                 parite: null, courant: false },
    { code: 'MGA', nom: 'Ariary malgache',              parite: null, courant: false },
    { code: 'MRU', nom: 'Ouguiya mauritanien',          parite: null, courant: false },
    { code: 'MUR', nom: 'Roupie mauricienne',           parite: null, courant: false },
    { code: 'MWK', nom: 'Kwacha malawien',              parite: null, courant: false },
    { code: 'MZN', nom: 'Metical mozambicain',          parite: null, courant: false },
    { code: 'NAD', nom: 'Dollar namibien',              parite: null, courant: false },
    { code: 'RWF', nom: 'Franc rwandais',               parite: null, courant: false },
    { code: 'SCR', nom: 'Roupie seychelloise',          parite: null, courant: false },
    { code: 'SDG', nom: 'Livre soudanaise',             parite: null, courant: false },
    { code: 'SLE', nom: 'Leone sierra-léonais',         parite: null, courant: false },
    { code: 'SOS', nom: 'Shilling somalien',            parite: null, courant: false },
    { code: 'SSP', nom: 'Livre sud-soudanaise',         parite: null, courant: false },
    { code: 'STN', nom: 'Dobra de Sao Tomé-et-Principe', parite: null, courant: false },
    { code: 'SZL', nom: 'Lilangeni swazi',              parite: null, courant: false },
    { code: 'TND', nom: 'Dinar tunisien',               parite: null, courant: false },
    { code: 'TZS', nom: 'Shilling tanzanien',           parite: null, courant: false },
    { code: 'UGX', nom: 'Shilling ougandais',           parite: null, courant: false },
    { code: 'ZAR', nom: 'Rand sud-africain',            parite: null, courant: false },
    { code: 'ZMW', nom: 'Kwacha zambien',               parite: null, courant: false },
    { code: 'ZWG', nom: 'Or du Zimbabwe (ZiG)',         parite: null, courant: false },

    /* --- Asie et Moyen-Orient ----------------------------------------- */
    { code: 'BDT', nom: 'Taka bangladais',              parite: null, courant: false },
    { code: 'BHD', nom: 'Dinar bahreïni',               parite: null, courant: false },
    { code: 'HKD', nom: 'Dollar de Hong Kong',          parite: null, courant: false },
    { code: 'IDR', nom: 'Roupie indonésienne',          parite: null, courant: false },
    { code: 'ILS', nom: 'Shekel israélien',             parite: null, courant: false },
    { code: 'IQD', nom: 'Dinar irakien',                parite: null, courant: false },
    { code: 'IRR', nom: 'Rial iranien',                 parite: null, courant: false },
    { code: 'JOD', nom: 'Dinar jordanien',              parite: null, courant: false },
    { code: 'JPY', nom: 'Yen japonais',                 parite: null, courant: false },
    { code: 'KRW', nom: 'Won sud-coréen',               parite: null, courant: false },
    { code: 'KWD', nom: 'Dinar koweïtien',              parite: null, courant: false },
    { code: 'LBP', nom: 'Livre libanaise',              parite: null, courant: false },
    { code: 'LKR', nom: 'Roupie srilankaise',           parite: null, courant: false },
    { code: 'MYR', nom: 'Ringgit malaisien',            parite: null, courant: false },
    { code: 'OMR', nom: 'Rial omanais',                 parite: null, courant: false },
    { code: 'PHP', nom: 'Peso philippin',               parite: null, courant: false },
    { code: 'PKR', nom: 'Roupie pakistanaise',          parite: null, courant: false },
    { code: 'QAR', nom: 'Riyal qatari',                 parite: null, courant: false },
    { code: 'SAR', nom: 'Riyal saoudien',               parite: null, courant: false },
    { code: 'SGD', nom: 'Dollar de Singapour',          parite: null, courant: false },
    { code: 'THB', nom: 'Baht thaïlandais',             parite: null, courant: false },
    { code: 'TWD', nom: 'Dollar de Taïwan',             parite: null, courant: false },
    { code: 'VND', nom: 'Dong vietnamien',              parite: null, courant: false },

    /* --- Europe hors zone euro ---------------------------------------- */
    { code: 'BGN', nom: 'Lev bulgare',                  parite: null, courant: false },
    { code: 'CHF', nom: 'Franc suisse',                 parite: null, courant: false },
    { code: 'CZK', nom: 'Couronne tchèque',             parite: null, courant: false },
    { code: 'DKK', nom: 'Couronne danoise',             parite: null, courant: false },
    { code: 'HUF', nom: 'Forint hongrois',              parite: null, courant: false },
    { code: 'ISK', nom: 'Couronne islandaise',          parite: null, courant: false },
    { code: 'NOK', nom: 'Couronne norvégienne',         parite: null, courant: false },
    { code: 'PLN', nom: 'Zloty polonais',               parite: null, courant: false },
    { code: 'RON', nom: 'Leu roumain',                  parite: null, courant: false },
    { code: 'RSD', nom: 'Dinar serbe',                  parite: null, courant: false },
    { code: 'RUB', nom: 'Rouble russe',                 parite: null, courant: false },
    { code: 'SEK', nom: 'Couronne suédoise',            parite: null, courant: false },
    { code: 'UAH', nom: 'Hryvnia ukrainienne',          parite: null, courant: false },

    /* --- Amériques et Océanie ----------------------------------------- */
    { code: 'ARS', nom: 'Peso argentin',                parite: null, courant: false },
    { code: 'AUD', nom: 'Dollar australien',            parite: null, courant: false },
    { code: 'BRL', nom: 'Réal brésilien',               parite: null, courant: false },
    { code: 'CAD', nom: 'Dollar canadien',              parite: null, courant: false },
    { code: 'CLP', nom: 'Peso chilien',                 parite: null, courant: false },
    { code: 'COP', nom: 'Peso colombien',               parite: null, courant: false },
    { code: 'MXN', nom: 'Peso mexicain',                parite: null, courant: false },
    { code: 'NZD', nom: 'Dollar néo-zélandais',         parite: null, courant: false },
    { code: 'PEN', nom: 'Sol péruvien',                 parite: null, courant: false },
    { code: 'UYU', nom: 'Peso uruguayen',               parite: null, courant: false }
  ];
  ...
  function liquider(dossier) {
    ...
    var resultats = lignes.map(function (l, index) {
      ...
      return {
        ...
        fob_xof: f(fob),
        fob_devise: nombre(l.fob_devise),
        poids_brut_kg: poids,
        poids_net_kg: nombre(l.poids_net_kg),
