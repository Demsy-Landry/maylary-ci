 ...
 * sept entrées sur deux lignes mangent le haut d'un petit écran, et l'atelier
 * a besoin de cette place.
 *
 * Le simulateur n'y figure plus : il s'est fondu dans « Déclaration ». Une
 * même saisie ne méritait pas deux portes.
 */
const ENTREES = [
